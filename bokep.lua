...
-- Author: 170F Team
-- Features: Silent Aim, Modern UI, Draggable, Expandable, Rainbow Text, Settings
...
local expandedSize = UDim2.new(0, 320, 0, 500)
...
hideButton.MouseButton1Click:Connect(function()
    ...
    wait(0.1)
    -- Show again with keyboard shortcut if needed
end)
...
local function performSilentAim()
    if silentAimActive and lockedTarget and lockedTargetCharacter then
...
print("🎯 Enable Silent Aim to lock onto nearby targets!")
