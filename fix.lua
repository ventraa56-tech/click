-- Roblox Kill Aura Script with Modern UI (FIXED)
-- Author: 170F Team
            ...
            if obj ~= humanoid and obj.Health > 0 and targetRootPart then
                ...
                if distance < auraRadius then
                    ...
                    if tick() - lastDamage >= auraDamageDelay then
                        -- FIX: Set health directly to 0 if damage is >= current health
                        if obj.Health - auraDamage <= 0 then
                            obj.Health = 0
